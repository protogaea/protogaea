...
| C | Искры: yespower, настольное приложение, WASM-клиент, журнал искр, наблюдатели | Начат: yespower с параметрами искры (в том числе на Rust для браузера) протокол искр в коде, приём искр на сервере с журналом и квитанциями и клиент искр в командной строке; дальше учёт работы и чудеса в ядре |
