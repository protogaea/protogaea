...
Текущее содержимое репозитория распространяется по [лицензии Apache 2.0](LICENSE). Для некоторых компонентов запланированы другие лицензии — например, AGPL-3.0 для сервера и веб-приложения; подробнее в [LICENSING.md](LICENSING.md). Название и логотип защищены [правилами использования товарного знака](TRADEMARKS.md).
