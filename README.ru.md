...
| C | Искры: yespower, настольное приложение, WASM-клиент, журнал искр, наблюдатели | Начат: yespower с параметрами искры (в том числе на Rust для браузера) и примитивы протокола искр: желания, искры, журнал искр и квитанции |
