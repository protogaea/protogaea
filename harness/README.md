...
- **Predators overexploit and die out.** With the default rules, hunters wipe out the grazers within 2–3 epochs, then starve among armored organisms they cannot beat. They die out on 16 of 16 seeds.
...
- **Cover works together with a small dispersal bonus.** With cover of +12 in forests, +10 in swamps and +14 in mountains, and a dispersal bonus of 10 per step instead of 50, predators survive one day on 13 of 16 seeds and three days on 14 of 16. This ruleset is [experiments/a1-cover.json](experiments/a1-cover.json).
- **Still open:** in most seeds a single clade holds more than 60% of the population for almost the whole three days.

The dispersal bonus of 10 is now the default. Cover stays off by default until the specification includes it.
