...
- Each plate gets its own biome mix, taken in turn from a published list (candidate: arid steppe, forest, highland, wetland); every mix keeps all five land biomes. The founder lineages (§9) go to the plates in turn and settle away from the future rifts, so every future continent starts with founders.
